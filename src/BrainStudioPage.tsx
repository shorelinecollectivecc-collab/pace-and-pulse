    ...
    <main className="brain-page">
      ...
      >
        ...
        <small>
          ...
          through puzzles, music and play
        </small>
      </section>
      ...
      <section className="brain-main-grid">
        <article className="brain-active-card">
          ...
          <div className="brain-active-body brain-active-body-engine">
            <div className="brain-tool-space brain-tool-space-engine">
              <BrainActivityEngine
